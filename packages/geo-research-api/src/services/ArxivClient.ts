...
export async function searchPapers(params: ArxivSearchParams = {}): Promise<ArxivPaper[]> {
  ...
  for (const block of entryBlocks) {
    ...
    // Date filtering (arXiv API doesn't support date range natively)
 ...
 * Useful for validating an ID before further processing.
 */
...
export async function discoverRecent(
  ...
  // Deduplicate by arXiv ID (a paper can appear in multiple categories)
